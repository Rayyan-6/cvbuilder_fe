      ...
      >
        <div style={{ flex: 1 }}>
          ...
          <input
            ...
            onChange={(e) =>
              onChange({ ...experience, jobTitle: e.target.value })
            }
            className="jobTitleStyle"
          />
        </div>
        <button onClick={onDelete} className="deleteBtnStyle">
          ✕
        </button>
      </div>
            ...
            <div key={idx} style={{ marginBottom: '10px', fontSize: '13px' }}>
              ...
              >
                <input
                  ...
                  value={proj.heading}
                  onChange={(e) =>
                    onUpdateProject(idx, 'heading', e.target.value)
                  }
              ...
              />
              <div
                style={{ fontSize: '11px', color: '#777', textAlign: 'right' }}
              >
