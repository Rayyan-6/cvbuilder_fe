...
function InsideComponent(props: SubSection) {
  return (
    <div className="relative pl-8 pb-6">
      {/* Vertical line */}
      <span className="absolute left-3 top-1 h-full w-px bg-black"></span>

      {/* Circle */}
      <span className="absolute left-[7px] top-2 w-3 h-3 rounded-full bg-black border-2 border-gray-500"></span>

      {/* Content */}
      <div>
        <span className="flex flex-row justify-between">
          <div className="font-bold">{props.degree}</div>
